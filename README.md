...
> 1. The assumption in the above proposition is equivalent to the condition that, for any uppercut $U$, if $r_i \in U \to q_i \in \overline{U}$ for all $i\in\iota$, then $b \in \overline{U} \to a \in U$.
